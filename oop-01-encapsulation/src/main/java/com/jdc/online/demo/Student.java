...
public class Student {
	...
	public Student cloneWithNewId(int id) {
		// Every time Java executes new Student(...), it creates a new object in memory.
	...
	@Override
	public int hashCode() {
		return Objects.hash(email, Integer.valueOf(id), name, phone);
	}
